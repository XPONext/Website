...
NAV = """
  <nav>
    ...
    <div class="nav-links">
      ...
      <div class="nav-dd">
        <a href="/website-check.html" class="nav-dd-trigger">Website-Check <span class="nav-dd-arrow">▾</span></a>
        <div class="nav-dd-menu">
          <a href="/website-check.html">SEO & Performance</a>
          <a href="/geo-check.html">GEO-Check</a>
        </div>
      </div>
